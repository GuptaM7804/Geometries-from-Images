...
function buildGeometries(imgArray, width, height) {
    ...
    while (curIndex < imgArray.length) {
        var centerX = j * cellsize + cellsize / 2 - width * cellsize / 2;
        var centerY = i * cellsize + cellsize / 2 - height * cellsize / 2;

        createBuilding(centerX, centerY, buildingsize, imgArray[curIndex]/255 * maxHeight, curIndex*5);
